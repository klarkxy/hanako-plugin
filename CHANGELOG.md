...
- 2026-05-25 [agent-fission] 生成包完成，版本从 1.0.6 自动递增到 1.0.7
- 2026-05-25 [text-tools] 生成包完成，版本保持 1.0.0
- 2026-05-25 [zhihu-search] 生成包完成，版本从 1.0.1 自动递增到 1.0.2

- 2026-05-26 [text-tools] 新增 text-tools 插件：提供 count_chars 字数统计工具，支持中文字数、所有字符数、UTF-8 字节数统计

- 2026-05-21 [agent-fission] 测试包完成，版本保持 1.0.6
- 2026-05-21 [roleplay] 测试包完成，版本保持 1.0.1

- 2026-05-21 [zhihu-search] 生成包完成，版本从 1.0.0 自动递增到 1.0.1

- 2026-05-20 [zhihu-search] 生成包完成，版本保持 1.0.0
